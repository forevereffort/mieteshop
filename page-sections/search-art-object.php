        ...
        <section id="js-search-art-object__results-section" class="search-results-section" data-nonce="<?php echo wp_create_nonce('filter_search_art_object_nonce'); ?>" data-search-key="<?php echo $searchKey; ?>">
            <div class="general-container">
                <div class="content-container">
                    ...
                    ?>
                            <div class="pcat-results-footer-options">
                                <div class="pcat-results-footer-options-col">
                                    <div id="js-search-art-object__results-navigation" class="pcat-results-navigation">
                                        <?php
                                ...
                                <div class="pcat-results-footer-options-col">
                                    <div class="pcat-results-footer-select">
                                        ...
                                        <div class="pcat-results-footer-select-elem">
                                            <select id="js-search-art-object__page-list">
                                                <?php
                    ...
                    ?>
                    <?php get_template_part('product/page-nav/page-nav', 'per-page', [ 'selectDomId' => "js-search-art-object__per-page" ]); ?>
                </div>
            </div>
        </section>
<?php
